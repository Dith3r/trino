        ...
        extends BaseRuleTest
{
    ...
    private static RuleTester tester(boolean connectorSupportsSingleColumnReads)
    {
        ...
        PlanTester planTester = PlanTester.create(
                session,
                metadata -> new DelegatingMetadata(metadata)
                {
                    @Override
            ...
            implements Metadata
    {
        ...
        {
            return metadata.getAllEntityKindPrivileges(entityKind);
        }
        ...
        {
            metadata.grantEntityPrivileges(session, entity, privileges, grantee, grantOption);
        }
        ...
        {
            metadata.denyEntityPrivileges(session, entity, privileges, grantee);
        }
        ...
        {
            metadata.revokeEntityPrivileges(session, entity, privileges, grantee, grantOption);
        }
