...
import static io.trino.spi.block.LazyResultBlock.createLazyResultBlockInternal;
import static java.lang.String.format;
import static java.util.Objects.checkIndex;
import static java.util.Objects.requireNonNull;

public class LazyResultBlockBuilder
        implements BlockBuilder
{
    private static final int INSTANCE_SIZE = instanceSize(LazyResultBlockBuilder.class);
    ...
    public LazyResultBlockBuilder(List<Type> fieldTypes, BlockBuilderStatus blockBuilderStatus, int expectedEntries)
    {
        this(
                blockBuilderStatus,
                fieldTypes.getFirst(),
    ...
    private LazyResultBlockBuilder(@Nullable BlockBuilderStatus blockBuilderStatus, Type type, BlockBuilder[] fieldBlockBuilders, boolean[] rowIsNull)
    {
    ...
    @Override
    public LazyResultBlock buildValueBlock()
    {
        if (currentEntryOpened) {
            throw new IllegalStateException("Current entry must be closed before the block can be built");
        }
        ...
        return createLazyResultBlockInternal(positionCount, type, hasNullRow ? rowIsNull : null, fieldBlocks);
    }
    ...
    {
        return format("LazyResultBlockBuilder{type=%s, positionCount=%d", type.toString(), getPositionCount());
    }
    ...
    public BlockBuilder newBlockBuilderLike(int expectedEntries, BlockBuilderStatus blockBuilderStatus)
    {
        ...
        return new LazyResultBlockBuilder(blockBuilderStatus, type, newBlockBuilders, new boolean[expectedEntries]);
    }
    ...
    private Block nullRle(int length)
    {
        ...
        LazyResultBlock nullRowBlock = createLazyResultBlockInternal(1, type, new boolean[] {true}, fieldBlocks);
